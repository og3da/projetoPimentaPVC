<?php 
    if(isset($_POST['submit'])){
      ...
      $sql = mysqli_query($conexao, "INSERT INTO tblFornecedor(cpf, nome, telefone, dtNasc, endereco, cep, bairro, uf, cidade, email) 
...
<div class="container">
  <h2>CADASTRAR FORNECEDORES</h2><hr><br>
  <form action="cadForn.php" method="POST">
    ...
    <div class="form-group">
      ...
      <input  class="form-control" id="cpf" placeholder="digite o CPF ou CNPJ" name="cpf">
    </div>
    <div class="form-group">
